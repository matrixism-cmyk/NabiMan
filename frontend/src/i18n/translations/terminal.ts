...
const t: T = {
  ...
  // --- Share links ---
  'share.button': { ko: '공유', en: 'Share', ja: '共有' },
  'share.hint': {
    ko: '이 터미널만 볼 수 있는 링크를 만들어 다른 사람에게 전달합니다.',
    en: 'Create a link that opens just this terminal for someone else.',
    ja: 'このターミナルだけを開くリンクを作成して他の人に渡します。',
  },
  'share.title': { ko: '터미널 공유 링크', en: 'Terminal share link', ja: 'ターミナル共有リンク' },
  'share.warning': {
    ko: '⚠ 링크를 받은 사람은 이 세션의 셸을 그대로 사용할 수 있습니다. 필요한 만큼만 짧게 열고, 끝나면 취소하세요.',
    en: '⚠ Anyone with the link gets this session\'s shell. Keep it short-lived and revoke it when you are done.',
    ja: '⚠ リンクを受け取った人はこのセッションのシェルを操作できます。短く設定し、終わったら取り消してください。',
  },
  'share.expiry': { ko: '만료', en: 'Expires', ja: '有効期限' },
  'share.1h': { ko: '1시간', en: '1 hour', ja: '1時間' },
  'share.6h': { ko: '6시간', en: '6 hours', ja: '6時間' },
  'share.24h': { ko: '24시간', en: '24 hours', ja: '24時間' },
  'share.3d': { ko: '3일', en: '3 days', ja: '3日' },
  'share.5d': { ko: '5일', en: '5 days', ja: '5日' },
  'share.10d': { ko: '10일', en: '10 days', ja: '10日' },
  'share.30d': { ko: '30일', en: '30 days', ja: '30日' },
  'share.forever': { ko: '영구', en: 'Never', ja: '無期限' },
  'share.password': { ko: '비밀번호 (선택)', en: 'Password (optional)', ja: 'パスワード (任意)' },
  'share.passwordPlaceholder': { ko: '비워두면 링크만으로 입장', en: 'Leave empty to let the link in on its own', ja: '空欄ならリンクだけで入室' },
  'share.passwordHint': {
    ko: '입력하면 링크를 연 사람이 이 비밀번호를 넣어야 터미널이 열립니다.',
    en: 'When set, whoever opens the link has to type it before the terminal appears.',
    ja: '設定すると、リンクを開いた人はこのパスワードを入力する必要があります。',
  },
  'share.readOnly': { ko: '읽기 전용', en: 'Read-only', ja: '読み取り専用' },
  'share.readOnlyHint': {
    ko: '화면만 보여주고 입력은 막습니다. 작업을 보여주기만 할 때 쓰세요.',
    en: 'They watch the screen but cannot type. Use it to show work in progress.',
    ja: '画面の閲覧のみで入力はできません。作業を見せるだけの場合に使います。',
  },
  'share.create': { ko: '링크 만들기', en: 'Create link', ja: 'リンクを作成' },
  'share.linkReady': { ko: '공유 링크', en: 'Share link', ja: '共有リンク' },
  'share.copy': { ko: '복사', en: 'Copy', ja: 'コピー' },
  'share.copied': { ko: '링크를 복사했습니다.', en: 'Link copied.', ja: 'リンクをコピーしました。' },
  'share.expiresAt': { ko: '만료', en: 'Expires', ja: '有効期限' },
  'share.withPassword': { ko: '비밀번호 있음', en: 'password required', ja: 'パスワードあり' },
  'share.noPassword': { ko: '비밀번호 없음', en: 'no password', ja: 'パスワードなし' },
  'share.existing': { ko: '이 세션의 기존 링크', en: 'Existing links for this session', ja: 'このセッションの既存リンク' },
  'share.link': { ko: '링크', en: 'Link', ja: 'リンク' },
  'share.options': { ko: '조건', en: 'Options', ja: '条件' },
  'share.revoke': { ko: '취소', en: 'Revoke', ja: '取り消し' },
  'share.revokeConfirm': {
    ko: '이 링크를 취소할까요? 링크를 가진 사람은 더 이상 접속할 수 없습니다.',
    en: 'Revoke this link? Whoever has it will no longer get in.',
    ja: 'このリンクを取り消しますか？リンクを持つ人は入れなくなります。',
  },
  'share.gateTitle': { ko: '공유된 터미널', en: 'Shared terminal', ja: '共有ターミナル' },
  'share.passwordPrompt': { ko: '비밀번호', en: 'Password', ja: 'パスワード' },
  'share.enter': { ko: '들어가기', en: 'Enter', ja: '入る' },
  'share.wrongPassword': { ko: '비밀번호가 맞지 않습니다.', en: 'That password does not match.', ja: 'パスワードが一致しません。' },
  'share.invalidTitle': { ko: '열 수 없는 링크', en: 'Link unavailable', ja: '開けないリンク' },
  'share.invalid': {
    ko: '이 링크는 만료되었거나 취소되었습니다.',
    en: 'This link has expired or been revoked.',
    ja: 'このリンクは期限切れか取り消されています。',
  },
  'share.panelTab': { ko: '공유 링크', en: 'Share links', ja: '共有リンク' },
  'share.panelTitle': { ko: '발급한 공유 링크', en: 'Share links you created', ja: '発行した共有リンク' },
  'share.panelWarning': {
    ko: '이 링크들은 지금도 터미널을 열 수 있습니다. 쓰지 않는 링크는 취소하세요.',
    en: 'These links still open a terminal. Revoke the ones you no longer need.',
    ja: 'これらのリンクは今もターミナルを開けます。不要なものは取り消してください。',
  },
  'share.none': { ko: '발급한 공유 링크가 없습니다.', en: 'No share links yet.', ja: '発行した共有リンクはありません。' },
  'share.expiresIn': { ko: '남은 기간', en: 'Expires in', ja: '残り期間' },
  'share.expiredNow': { ko: '만료됨', en: 'expired', ja: '期限切れ' },
  ...
  'share.headTitle': { ko: '공유된 터미널', en: 'Shared terminal', ja: '共有ターミナル' },
  'share.ended': { ko: '세션 종료됨', en: 'session ended', ja: 'セッション終了' },
  ...
  'remote.overviewHint': {
    ko: '요약 · 세션 · 링크 · SSH 키',
    en: 'Summary, sessions, links, SSH key',
    ja: '要約・セッション・リンク・SSH鍵',
  },
